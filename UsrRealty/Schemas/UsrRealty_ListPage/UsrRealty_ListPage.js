			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "9cf1c7fc-ea1a-ba71-ec9d-5c104a88169f",
							"code": "PDS_UsrPrice",
							"caption": "#ResourceString(PDS_UsrPrice)#",
							"dataValueType": 32
						},
						{
							"id": "730a485e-ec84-0058-3d02-7884a358aa92",
							"code": "PDS_UsrType",
							"caption": "#ResourceString(PDS_UsrType)#",
							"dataValueType": 10
						},
						{
							"id": "0583f151-f2aa-8a67-d2b7-f0a662bffad7",
							"code": "PDS_UsrOfferType",
							"caption": "#ResourceString(PDS_UsrOfferType)#",
							"dataValueType": 10
						},
						{
							"id": "69540067-6f72-f60f-07f0-7b543521a3ec",
							"code": "PDS_UsrNumber",
							"caption": "#ResourceString(PDS_UsrNumber)#",
							"dataValueType": 27
						},
						{
							"id": "801022ec-2765-0354-9e81-f51ead698ff1",
							"code": "PDS_CreatedOn",
